...
class SecretServerInfo extends React.Component {
  ...
  render() {
    return (<div className="secret-component container">
      <div className="col-md-12">
        <div className="col-md-6">
          <section>
            <h5>{this.state.title}</h5>
            <div className="well" key="selected-secret-element" >
...
module.exports = SecretServerInfo